...
<div class="card">
    <div class="header">
            <h3 class="box-title">{{ trans('menu::menu.titles.create menu item') }}</h3>
        </div>
    <div class="card">
        <div class="header">
    ...
    <div class="body">
        ...
        <a class="btn btn-danger pull-right btn-flat m-r-15 waves-effect" href="{{ URL::route('admin.menu.menu.edit', [$menu->id])}}"><i class="fa fa-times"></i> {{ trans('core::core.button.cancel') }}</a>
    </div>
</div>
{!! Form::close() !!}
@stop
