    ...
    <div class="col-md-9">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="footer">
                    <button type="submit" class="btn btn-primary btn-flat m-l-15 waves-effect" name="button" value="index" >
                        <i class="fa fa-angle-left"></i>
                        {{ trans('core::core.button.update and back') }}
                    </button>
                    <button type="submit" class="btn btn-primary btn-flat waves-effect">
        ...
        <div class="card">
            <div class="body">
                <div class="demo-checkbox{{ $errors->has('is_home') ? ' has-error' : '' }}">
                    ...
                    <input id="basic_checkbox_2" name="is_home" type="checkbox" class="flat-blue" {{ isset($page->is_home) && (bool)$page->is_home == true ? 'checked' : '' }} value="1" />
                ...
                <div class='form-group{{ $errors->has("template") ? ' has-error' : '' }} form-float'>
                    ...
                    {!! Form::select("template", $all_templates, old("template", $page->template), ['class' => "form-control show-tick"]) !!}
