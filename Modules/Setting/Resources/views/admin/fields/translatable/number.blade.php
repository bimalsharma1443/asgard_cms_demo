<div class='form-group form-float'>
	<div class="form-line">
	    ...
	    <?php if (isset($dbSettings[$settingName])): ?>
	        ...
	        {!! Form::input('number', $settingName . "[$lang]", Input::old($settingName . "[$lang]", $value), ['class' => 'form-control']) !!}
	    <?php else: ?>
	        {!! Form::input('number', $settingName . "[$lang]", Input::old($settingName . "[$lang]"), ['class' => 'form-control']) !!}
	    <?php endif; ?>
	</div>
</div>
