<div class='form-group form-float'>
	<div class="form-line">
	    ...
	    <?php if (isset($dbSettings[$settingName])): ?>
	        ...
	        {!! Form::textarea($settingName . "[$lang]", Input::old($settingName . "[$lang]", $value), ['class' => 'form-control ckeditor']) !!}
	    <?php else: ?>
	        {!! Form::textarea($settingName . "[$lang]", Input::old($settingName . "[$lang]"), ['class' => 'form-control ckeditor']) !!}
	    <?php endif; ?>
	</div>
</div>
